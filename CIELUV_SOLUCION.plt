...
set xrange [ -140.000 : 180.000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "U" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ -140.000 : 180.000 ] noreverse nowriteback
set y2range [ * : * ] noreverse nowriteback
set zlabel "V" 
set zlabel  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set zrange [ -140.000 : 180.000 ] noreverse nowriteback
set cblabel "" 
...
set rmargin  -1
set tmargin  -1
set locale "Spanish_Mexico.1252"
...
GNUTERM = "wxt"
GPFUN_rgb = "rgb(r,g,b) = 65536 * int(r) + 256 * int(g) + int(b)"
splot "tetra.txt" with lines lc rgb "light-gray","tetra.txt"  with points pt 2 ps 1 lc rgb "blue","recocido.txt" using 1:2:3:(rgb($4,$5,$6)) with points lc rgb variable pt 7 ps 1.2
#    EOF
