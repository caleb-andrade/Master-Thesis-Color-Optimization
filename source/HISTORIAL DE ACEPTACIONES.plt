...
# set terminal wxt 0 background '#d3d3d3'
# set output
unset clip points
set clip one
unset clip two
...
plot 'historial.txt' with lines lc rgb "blue", 'temperatura.txt' with points pt 7 ps .7 lc rgb "red","optimo.txt" with points pt 3 ps 1.2 lc rgb "black"
#    EOF
